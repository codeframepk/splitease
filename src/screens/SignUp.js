...
import { Container, View, Header, Form, Item, Label, Input, Content, Button, Text, Left, Body, Right, Title, Icon } from 'native-base';
...
export default class SignUp extends Component {
    ...
    handleForm = () => {
        ...
        if (data.name == '') {
            ...
            auth.createUserWithEmailAndPassword(data.email, this.state.pass)
                .then(() => {
                        ...
                        <Item>
                            ...
                            />
                            {
                                this.state.secureTextEntry == true
                                    ...
                                    : (<TouchableOpacity onPress={() => { this.setState({ secureTextEntry: true }) }}>
