...
import { Container, Form, Item, Label, Input, Content, Button, Text, Header, Left, Body, Right, Icon, Title } from 'native-base';
    ...
    handleMember = () => {
        ...
        auth.onAuthStateChanged((user) => {
            if (user) {
                ...
                db.collection('AddMembers').where("venmoId", "==", newMember.venmoId).get().then((members) => {
                ...
                <Content padder>
                    ...
                    <View>
                        <Image
                            ...
                            source={require('../images/splitzease-logo.gif')}
                        />
                    </View>
                    <Form >
                        <Item>
                        ...
                        <Button primary full onPress={() => this.handleMember()}
